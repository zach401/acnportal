...
for i in range(24):
    ax = fig.add_subplot(4, 6, i + 1)
    density_weekday, density_edges_weekday = stat_model.stay_density_arrays[i], stat_model.stay_density_edges[
        i].tolist()
...
ax.set_title(
    'The two charging stages of a piece-wise linear battery\nmodel and the corresponding maximum charging rate')
