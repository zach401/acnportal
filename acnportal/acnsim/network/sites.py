...
class CaltechACN(ChargingNetwork):
    ...
    def __init__(self, basic_evse=False, voltage=208):
        ...
        self.add_constraint(I3a, 420, name='Secondary A')
        self.add_constraint(I3b, 420, name='Secondary B')
        self.add_constraint(I3c, 420, name='Secondary C')
        self.add_constraint(I2a, 180, name='Primary A')
        self.add_constraint(I2b, 180, name='Primary B')
        self.add_constraint(I2c, 180, name='Primary C')
